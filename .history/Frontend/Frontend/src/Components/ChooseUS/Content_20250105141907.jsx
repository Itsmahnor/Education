  ...
  return (
    <section className="bg-[#04211e] text-[#ffffff] py-16 px-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative bg-[#098E68] rounded-lg shadow-lg p-6">
          <img
          ...
          />
          <h3 className="text-2xl font-bold text-[#098E68] mt-6">Key Features</h3>
          <ul className="mt-4 space-y-3 text-[#b8b8b8]">
            <li>✓ Scholarships</li>
