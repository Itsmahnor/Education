...
const BecomeInstructorSection = () => {
  return (
    <div className="bg-orange-900 text-orange-400 px-8 py-10 w-[100vw] flex justify-center items-center">
      <div className='w-[70vw]'>
      {/* Title Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold uppercase mb-4">Become an Instructor</h2>
        <h3 className="text-3xl font-bold mb-6">Start Teaching with SkillsEducation</h3>
        <p className="text-lg">
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold uppercase mb-4">Requirements to Become an Instructor:</h2>
      ...
      {/* Benefits Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold uppercase mb-4">Benefits of Becoming an Instructor:</h2>
        <ul className="list-none space-y-3">
      ...
      {/* Salary Section */}
      <div>
        <h2 className="text-2xl font-bold uppercase mb-4">Instructor Salary:</h2>
        <p className="text-lg">
