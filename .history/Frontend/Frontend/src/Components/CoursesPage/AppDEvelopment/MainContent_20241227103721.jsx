    ...
    <div className="w-full flex flex-col items-center pt-16 bg-orange-950 text-orange-500">
      ...
      <div className="md:w-[80vw] w-[95vw] flex lg:flex-row flex-col gap-7 justify-between">
        ...
        <div className="lg:w-[60%]">
          ...
          {/* Course Outline */}
          <div className="bg-brown-900  py-12 px-6 mt-7">
      ...
      {Data.outline.map((monthData, index) => (
        <div key={index} className="mb-8 text-white ">
          {/* Button for toggling */}
          <button
            className="w-full bg-orange-500 text-brown-900 transition-all duration-500 overflow-hidden font-semibold text-left px-6 py-3 rounded-t-lg shadow-md"
