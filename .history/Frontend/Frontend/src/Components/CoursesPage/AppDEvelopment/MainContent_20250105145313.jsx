    ...
    <div className="w-full flex flex-col items-center pt-16 bg-[#04211e] text-[#ffffff]">
      ...
      <div className="md:w-[80vw] w-[95vw] flex lg:flex-row flex-col gap-7 justify-between">
        ...
        <div className="lg:w-[60%]">
          ...
          {/* Course Outline */}
          <div className="bg-[#2e2e2e] py-12 px-6 mt-7">
        ...
        {/* Right Section */}
        <div className="lg:w-[35%] w-full lg:h-[35vh] bg-[#098E68] rounded-lg flex flex-col justify-center items-center text-black font-bold p-5">
