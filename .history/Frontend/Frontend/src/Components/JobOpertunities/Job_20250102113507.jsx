    ...
    <section className="bg-gray-900 py-10">
      ...
      <div className="flex justify-center mb-8">
        <input
          ...
          className="w-2/3 md:w-1/3 px-4 py-2 bg-gray-800 border border-gray-700 text-gray-300 rounded-l-lg focus:outline-none"
        />
      ...
      {/* Highlight Section */}
      <div className="bg-blue-900 mt-12 py-8 text-center rounded-lg">
